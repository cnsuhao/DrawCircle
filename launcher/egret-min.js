...
(function (d) {
    function f(c) {
        ...
        if (a = d.egret_string_code[c]) for (var g = b.length, v = 0; v < g; v++) a = a.replace("{" + v + "}", b[v]);
        return a
    }
    var e = function () {
        function c() {}
        c.openLogByType = function (b) {
            ...
            case c.INFO:
                console.log = c.logFuncs.log,
                console.info = c.logFuncs.info;
            case c.WARN:
        ...
        c.warningWithErrorId = function (b) {
            for (var a = [], g = 1; g < arguments.length; g++) a[g - 1] = arguments[g];
            a.unshift(b);
            (a = f.apply(null, a)) ? c.warning(a) : c.warning(f(-1, b))
        };
...
(function (d) {
    var f = function (d) {
        ...
        b.push = function (a) {
            var g = this.objectPool; - 1 == g.indexOf(a) && (g.push(a), a.__recycle && a.__recycle(), this._length++, 0 == this.frameCount && (this.frameCount = this.autoDisposeTime, c._callBackList.push(this)))
        };
        b.pop = function () {
...
(function (d) {
    var f = function (e) {
        ...
        c._dispatchByTarget = function (a, g, b, c, e, k) {
            void 0 === e && (e = !1);
            void 0 === k && (k = !1);
...
(function (d) {
    var f = function (e) {
        function c(a, g, b, c, d, k, f, m, l, n) {
            void 0 === g && (g = !0);
            void 0 === b && (b = !0);
            void 0 === c && (c = 0);
            void 0 === d && (d = 0);
        ...
        c.dispatchTouchEvent = function (a, g, b, w, e, k, f, m, l) {
            void 0 === b && (b = 0);
            void 0 === w && (w = 0);
            void 0 === e && (e = 0);
            void 0 === k && (k = !1);
    ...
    var f = function (e) {
        ...
        b._insertEventBin = function (a, g, b, c, d) {
            ...
            for (var e = -1, f = a.length, m = 0; m < f; m++) {
                var l = a[m];
                if (l.listener == g && l.thisObject == b && l.display == d) return !1; - 1 == e && l.priority < c && (e = m)
            }
            g = {
                listener: g,
                thisObject: b,
...
delete testRuntimeType;
    ...
    (function (d) {
        ...
        d.getDefinitionByName = function (d) {
            ...
            var c = f[d];
            if (c) return c;
            for (var b = d.split("."), a = b.length, c = __global, g = 0; g < a; g++) if (c = c[b[g]], !c) return null;
            return f[d] = c
        }
    })(egret || (egret = {}));
var __global = __global || this;
    (function (d) {
        ...
        d.setTimeout = function (b, a, g) {
                for (var v = [], w = 3; w < arguments.length; w++) v[w - 3] = arguments[w];
                v = {
                    listener: b,
                    thisObject: a,
                    delay: g,
        ...
        var f = function (e) {
            ...
            b.append = function (a, g, b, c, d, e) {
                var f = this.a,
                    ...
                    l = this.c,
                    n = this.d;
                if (1 != a || 0 != g || 0 != b || 1 != c) this.a = a * f + g * l,
                this.b = a * m + g * n,
                this.c = b * f + c * l,
                this.d = b * m + c * n;
            ...
            b.prependTransform = function (a, g, b, c, e, f, h, m, l) {
                ...
                if (m || l) this.tx -= m,
                this.ty -= l;
                f || h ? (this.prepend(n * b, e * b, -e * c, n * c, 0, 0), this.prepend(d.NumberUtils.cos(h), d.NumberUtils.sin(h), -d.NumberUtils.sin(f), d.NumberUtils.cos(f), a, g)) : this.prepend(n * b, e * b, -e * c, n * c, a, g);
                return this
            };
            b.appendTransform = function (a, g, b, c, e, f, h, m, l) {
                ...
                if (m || l) this.tx -= m * this.a + l * this.c,
                this.ty -= m * this.b + l * this.d;
                return this
            };
            b.rotate = function (a) {
                var g = Math.cos(a);
            ...
            b.drawImage = function (a, g, b, e, f, k, h, m, l, n, p) {
                ...
                if (null != r && 0 != k && 0 != f && 0 != l && 0 != n) {
                    ...
                    if (0 != this._drawAreaList.length && d.MainContext.instance.rendererContext._cacheCanvasContext) {
                        ...
                        q.destWidth = l;
                        q.destHeight = n;
                        for (var t = this.getDrawAreaList(), x = 0; x < t.length; x++) if (!this.ignoreRender(g, t[x], q.destX, q.destY)) {
    ...
    (function (d) {
        var f = function (e) {
            ...
            b.drawCacheTexture = function (a) {
                ...
                if (this._cacheDirty || null == this._texture_to_render || 1 < g.width - this._texture_to_render._textureWidth || 1 < g.height - this._texture_to_render._textureHeight) this._cacheDirty = !this._makeBitmapCache();
            ...
            b._getOffsetPoint = function () {
                ...
                if (0 != this._anchorX || 0 != this._anchorY) g = this._getSize(d.Rectangle.identity),
                a = this._anchorX * g.width,
                g = this._anchorY * g.height;
            ...
            b.addEventListener = function (a, g, b, w, f) {
                void 0 === w && (w = !1);
                void 0 === f && (f = 0);
                e.prototype.addEventListener.call(this, a, g, b, w, f);
            ...
            c.getTransformBounds = function (a, g) {
                ...
                d * g.b,
                    ...
                    (b = m + l) < p ? p = b : b > r && (r = b);
                    (c = d + n) < q ? q = c : c > t && (t = c);
                    (c = d + e + n) < q ? q = c : c > t && (t = c);
                    (c = e + n) < q ? q = c : c > t && (t = c);
                return a.initialize(p, q, r - p, t - q)
            };
    ...
    (function (d) {
        var f = function (e) {
            ...
            b._doAddChild = function (a, g, b) {
                void 0 === b && (b = !0);
                if (a == this) return a;
                if (0 > g || g > this._children.length) return d.Logger.fatalWithErrorId(1007),
                a;
                var e = a._parent;
                ...
                if (this._stage) for (a._onAddToStage(), g = c.__EVENT__ADD_TO_STAGE_LIST; 0 < g.length;) e = g.shift(),
                b && e.dispatchEventWith(d.Event.ADDED_TO_STAGE);
                a._setDirty();
                this._setSizeDirty();
                return a
            };
            ...
            b.swapChildren = function (a, g) {
                var b = this._children.indexOf(a),
                    c = this._children.indexOf(g); - 1 == b || -1 == c ? d.Logger.fatalWithErrorId(1008) : this._swapChildrenAt(b, c)
            };
            ...
            b._updateTransform = function () {
                if (this._visible) {
                    ...
                    if (!this._cacheAsBitmap || !this._texture_to_render) for (var g = 0, b = this._children, c = b.length; g < c; g++) b[g]._updateTransform();
            ...
            b._render = function (a) {
                if (!d.MainContext.__use_new_draw) for (var g = 0, b = this._children, c = b.length; g < c; g++) b[g]._draw(a)
            };
            b._measureBounds = function () {
                for (var a =
            ...
            b.hitTest = function (a, g, b) {
                ...
                if (this._scrollRect) {
                    if (a < this._scrollRect.x || g < this._scrollRect.y || a > this._scrollRect.x + this._scrollRect.width || g > this._scrollRect.y + this._scrollRect.height) return null
            ...
            b.getChildByName = function (a) {
                for (var g = this._children, b = g.length, c, d = 0; d < b; d++) if (c = g[d], c.name == a) return c;
                return null
            };
...
egret.Stage.SCALE_MODE_ENUM[egret.StageScaleMode.EXACT_FIT] = new egret.FullScreen;
    (function (d) {
        var f = function (e) {
            ...
            b.setScrollPosition = function (a, g, b) {
                void 0 === b && (b = !1);
                if (!b || 0 != a || 0 != g) if (b || this._scrollTop != a || this._scrollLeft != g) {
                    if (b) {
            ...
            b._validatePosition = function (a, g) {
                ...
                g && (b = this.width, c = this._getContentWidth(), this._scrollLeft = Math.max(this._scrollLeft, (0 - b) / 2), this._scrollLeft = Math.min(this._scrollLeft, c > b ? c - b / 2 : b / 2))
            };
            b._setWidth = function (a) {
            ...
            b._calcVelocitys = function (a) {
                var g = d.getTimer();
                if (0 == this._lastTouchTime) this._lastTouchTime = g;
                else {
            ...
            b._moveAfterTouchEnd = function () {
                if (0 != this._velocitys.length) {
                    ...
                    a = 0.02 < e ? this.getAnimationDatas(a, this._scrollLeft, f) : {
    ...
    (function (d) {
        var f = function (e) {
            ...
            b._render = function (a) {
                var g = this._texture;
                g ? (this._texture_to_render = g, c._drawBitmap(a, this._hasWidthSet ? this._explicitWidth : g._textureWidth, this._hasHeightSet ? this._explicitHeight : g._textureHeight, this)) : this._texture_to_render = null
            };
                ...
                if (e) {
                    ...
                    if ("scale" == d.fillMode) {
                            ...
                            if (m && f - m.width < g && h - m.height < b) c.drawScale9GridImage(a, d, m, g, b);
                                ...
                                l = Math.round(l * b);
                                b = Math.round(p * b);
                                c.renderFilter.drawImage(a, d, e._bitmapX, e._bitmapY, n, p, m, l, g, b)
                            }
            ...
            c.drawScale9GridImage = function (a, g, b, c, e) {
                ...
                if (h && b) {
                        ...
                        if (!a.drawImageScale9(h, n, p, r, q, h._offsetX, h._offsetY, c, e, b)) {
                                ...
                                h.drawImage(a, g, t, p, b.width, b.y, A, l, r - b.x, b.y);
                                h.drawImage(a, g, x, p, u, b.y, m + r, l, c - r, b.y);
                                h.drawImage(a, g, n, y, b.x, b.height, m, B, b.x, q - b.y);
                                h.drawImage(a, g, t, y, b.width, b.height, A, B, r - b.x, q - b.y);
                                h.drawImage(a, g, x, y, u, b.height, m + r, B, c - r, q - b.y);
                                h.drawImage(a, g, n, f, b.x, z, m, l + q, b.x, e - q);
                                h.drawImage(a, g, t, f, b.width, z, A, l + q, r - b.x, e - q);
                                h.drawImage(a, g, x, f, u, z, m + r, l + q, c - r, e - q)
                            }
                    }
            };
            b._measureBounds = function () {
        ...
        var f = function (e) {
            ...
            b._render = function (a) {
                var g = this._getTextLines(),
                    b = g.length;
                if (0 != b) {
                        for (var e = this._font, f = e._getFirstCharHeight(), f = Math.ceil(f * c.EMPTY_FACTOR), k = 0, h = this._hasHeightSet ? this._explicitHeight : Number.POSITIVE_INFINITY, m = this._lineHeights, l = 0; l < b; l++) {
                            var n = m[l];
                            if (0 < l && k + n > h) break;
                            for (var p = g[l], r = p.length, q = 0, t = 0; t < r; t++) {
                                var x = p.charAt(t),
                                    u = e.getTexture(x);
                                if (u) {
                                        var x = u._bitmapWidth || u._textureWidth,
                                            y = u._bitmapHeight || u._textureHeight;
                                        this._texture_to_render = u;
                                        d.RenderFilter.getInstance().drawImage(a, this, u._bitmapX, u._bitmapY, x, y, q + u._offsetX, k + u._offsetY, x, y);
                                        q += u._textureWidth
            ...
            b._getTextLines = function () {
                ...
                for (var b = 0, e = 0, f = 0, k = 0, h = this._hasWidthSet, m = this._hasWidthSet ? this._explicitWidth : Number.POSITIVE_INFINITY, l = this._font, n = l._getFirstCharHeight(), p = Math.ceil(n * c.EMPTY_FACTOR), r = this._text.split(/(?:\r\n|\r|\n)/), q = r.length, t = !0, x = 0; x < q; x++) {
                    for (var u = r[x], y = u.length, z = 0, A = 0, B = !0, D = 0; D < y; D++) {
                        var C = u.charAt(D),
                            F, G = 0,
                            H = 0,
                            E = l.getTexture(C);
                        ...
                        t && (k = Math.min(H, k));
                        h && 0 < D && A + C > m ? (a.push(u.substring(0, D)), g.push(z), e += z, b = Math.max(A, b), u = u.substring(D), y = u.length, D = 0, A = C, z =
    ...
    (function (d) {
        var f = function () {
            ...
            c.drawRoundRect = function (b, a, g, c, d, e) {
                this.checkRect(b, a, g, c)
            };
            ...
            c.checkRect = function (b, a, g, c) {
                this._firstCheck ? (this._firstCheck = !1, this._minX = b, this._minY = a, this._maxX = b + g, this._maxY = a + c) : (this._minX = Math.min(this._minX, b), this._minY = Math.min(this._minY, a), this._maxX = Math.max(this._maxX, b + g), this._maxY = Math.max(this._maxY, a + c))
            };
    ...
    (function (d) {
        var f = function () {
            ...
            e._getHit = function (c, b, a) {
                ...
                if (0 === d) return null;
                c = g[d - 1];
                for (f = a = 0; f < c.elements.length; f++) if (g = c.elements[f], a + g.width < b) a += g.width;
                else return {
                    lineIndex: d - 1,
                    textElementIndex: f
                };
        ...
        var f = function (e) {
            ...
            b.fillBackground = function () {
                var a = this._bgGraphics,
                    g = this._properties;
                a && a.clear();
                if (g._background || g._border) null == a && (a = this._bgGraphics = new d.Graphics),
                g._background && a.beginFill(g._backgroundColor, 1),
                g._border && a.lineStyle(1, g._borderColor),
                ...
                for (var e = this._linesArr, f = 0, k = 0, h = 0, m = 0, l, n = 0, p = b.length; n < p; n++) {
                        ...
                        for (var q = r.text.toString().split(/(?:\r\n|\r|\n)/), t = 0, x = q.length; t < x; t++) {
                            ...
                            if ("" == q[t]) t == x - 1 && (u = !1);
                                    ...
                                    var y = c.measureText(q[t]);
                                    if (this._hasWidthSet) if (f + y <= this._explicitWidth) l.elements.push({
                                        width: y,
                                        text: q[t],
                                        style: r.style
                                    }),
                                    ...
                                    t == x - 1 && (u = !1);
                                        ...
                                        for (var z = u = 0, A = q[t], B = A.length; u < B; u++) {
                                            y = c.measureText(A.charAt(u));
                                            if (f + y > this._explicitWidth && 0 != f + u) break;
                                            z += y;
                                            f += y;
                                            k += 1
                                        }
            ...
            b.drawText = function (a) {
                ...
                if (0 != b._textMaxWidth) {
                        ...
                        if (this._hasHeightSet && this._explicitHeight > f) var m = d.TextFieldUtils._getValign(this),
                        ...
                        for (var k = Math.round(k), f = d.TextFieldUtils._getHalign(this), m = 0, l = h, n = b._numLines; l < n; l++) {
                                ...
                                for (var m = Math.round((e - p.width) * f), q = 0, t = p.elements.length; q < t; q++) {
                                        var x = p.elements[q];
    ...
    (function (d) {
        var f = function (e) {
            ...
            b._getFrameLabelByName = function (a, b) {
                ...
                if (c) for (var d = null, e = 0; e < c.length; e++) if (d = c[e], b ? d.name.toLowerCase() === a : d.name === a) return d;
                return null
            };
    ...
    (function (d) {
        var f = function (e) {
            ...
            b._fillFramesData = function (a) {
                for (var b =
                this.frames, c = a ? a.length : 0, d, e = 0; e < c; e++) if (d = a[e], b.push(d), d.duration) {
    ...
    (function (d) {
        var f = function (e) {
            ...
            b.drawToTexture = function (a, b, e) {
                ...
                e = a._anchorOffsetX;
                n = a._anchorOffsetY;
                if (0 != a._anchorX || 0 != a._anchorY) e = a._anchorX * m,
                n = a._anchorY * l;
                this._offsetX = s + e;
                this._offsetY = k + n;
                a._worldTransform.append(1, 0, 0, 1, -this._offsetX, -this._offsetY);
                b && (this._offsetX -= s, this._offsetY -= k);
                a.worldAlpha = 1;
                if (a instanceof d.DisplayObjectContainer) for (b = a._children, s = 0, k = b.length; s < k; s++) b[s]._updateTransform();
    ...
    (function (d) {
        var f = function () {
            ...
            e.parseNode = function (c) {
                ...
                a = c.childNodes;
                g = a.length;
                for (d = 0; d < g; d++) if (f = e.parseNode(a[d])) b.children || (b.children = []),
                f.parent = b,
                b.children.push(f);
            ...
            e.findByPath = function (c, b, a) {
                ...
                if (c = c.children) for (var f = c.length, s = 0; s < f; s++) {
                        var k = c[s];
                        k.localName == d && (g ? a.push(k) : e.findByPath(k, b, a))
                    }
            };
        ...
        var e = function () {
            ...
            b.decodeUTF8 = function (a) {
                for (var b = 0, c = "", d, e = 0, f = 0, h = 0, m = 0; a.length > b;) {
                    ...
                    else if (0 === f) this.inRange(d, 0, 127) || (this.inRange(d, 194, 223) ? (f = 1, m = 128, e = d - 192) : this.inRange(d, 224, 239) ? (f = 2, m = 2048, e = d - 224) : this.inRange(d, 240, 244) ? (f = 3, m = 65536, e = d - 240) : this.decoderError(!1), e *= Math.pow(64, f), d = null);
        ...
        var f = function (e) {
            ...
            b._updateTargetProps = function (a, b) {
                ...
                for (var h in this._initQueueProps) {
                    ...
                    var m = !1;
                    if (k = c._plugins[h]) for (var l = 0, n = k.length; l < n; l++) {
            ...
            b._appendQueueProps = function (a) {
                ...
                for (h in a) if (void 0 === this._initQueueProps[h]) {
                    d = this._target[h];
                    if (b = c._plugins[h]) for (e = 0, f = b.length; e < f; e++) d = b[e].init(this, h, d);
                    this._initQueueProps[h] = this._curQueueProps[h] = void 0 === d ? null : d
                }
                for (h in a) {
                    d = this._curQueueProps[h];
                    if (b = c._plugins[h]) for (k = k || {}, e = 0, f = b.length; e < f; e++) b[e].step && b[e].step(this, h, d, a[h], k);
...
for (var egret_sin_map = {}, egret_cos_map = {}, NumberUtils_i = 0; 90 >= NumberUtils_i; NumberUtils_i++) egret_sin_map[NumberUtils_i] = Math.sin(NumberUtils_i * egret.Matrix.DEG_TO_RAD),
    ...
    (function (d) {
        var f = function (e) {
            ...
            b.registerListener = function () {
                ...
                var s, k;
                "undefined" !== typeof document.hidden ? (s = "hidden", k = "visibilitychange") : "undefined" !== typeof document.mozHidden ? (s = "mozHidden", k = "mozvisibilitychange") : "undefined" !== typeof document.msHidden ? (s = "msHidden", k = "msvisibilitychange") : "undefined" !== typeof document.webkitHidden ? (s = "webkitHidden", k = "webkitvisibilitychange") : "undefined" !== typeof document.oHidden && (s = "oHidden", k = "ovisibilitychange");
                "onpageshow" in window && "onpagehide" in window && (window.addEventListener("pageshow", e, !1), window.addEventListener("pagehide", b, !1));
                s && k && document.addEventListener(k, f, !1)
            };
            c.instance = null;
...
var egret_html5_localStorage;
    (function (d) {
        ...
        d.setItem = function (d, e) {
            try {
                return window.localStorage.setItem(d, e),
                !0
            } catch (c) {
                return egret.Logger.infoWithErrorId(1018, d, e),
                !1
            }
        };
        d.removeItem = function (d) {
...
egret_html5_localStorage.init();
    (function (d) {
        var f = function (e) {
            ...
            b.drawImage = function (a, b, c, f, s, k, h, m, l, n) {
                void 0 === n && (n = void 0);
                var p = a._bitmapData;
                k += this._transformTx;
                h += this._transformTy;
                var r = d.getTimer();
                void 0 === n ? this.drawCanvasContext.drawImage(p, b, c, f, s, k, h, m, l) : this.drawRepeatImage(a, b, c, f, s, k, h, m, l, n);
                e.prototype.drawImage.call(this, a, b, c, f, s, k, h, m, l, n);
            ...
            b.drawRepeatImage = function (a, b, c, e, f, k, h, m, l, n) {
                if (void 0 === a.pattern) {
                    ...
                    q.width = e * p,
                    q.height = f * p,
                    q.getContext("2d").drawImage(r, b, c, e, f, 0, 0, e * p, f * p);
            ...
            b.drawText = function (a, b, c, f, s, k) {
                void 0 === k && (k = null);
                this.setupFont(a, k);
                k = k || {};
                var h = a._properties,
                ...
                n.fillStyle = m;
                n.strokeStyle = l;
                h && (n.lineWidth = 2 * h, n.strokeText(b, c + this._transformTx, f + this._transformTy, s || 65535));
                n.fillText(b, c + this._transformTx, f + this._transformTy, s || 65535);
                e.prototype.drawText.call(this, a, b, c, f, s, k)
            };
            b.strokeRect = function (a, b, c, d, e) {
            ...
            b.onRenderFinish = function () {
                this.drawCanvasContext.restore();
                this.drawCanvasContext.setTransform(1, 0, 0, 1, 0, 0);
                if (this.useCacheCanvas) for (var a = this._cacheCanvas.width, b = this._cacheCanvas.height, c = d.RenderFilter.getInstance().getDrawAreaList(), e = 0, f = c.length; e < f; e++) {
                    var k = c[e],
                        h = k.x,
                        m = k.y,
                        l = k.width,
...
var egret_h5_graphics;
    (function (d) {
        ...
        d.drawCircle = function (d, c, b) {
            this._pushCommand(new f(function (a, b, c) {
        ...
        d.drawRoundRect = function (d, c, b, a, g, v) {
            this._pushCommand(new f(function (a, b, c, d, g, e) {
                ...
                this.canvasContext.quadraticCurveTo(c, d, c - g, d);
        ...
        d.lineStyle = function (d, c, b, a, g, v, w, s) {
            void 0 === d && (d = NaN);
            void 0 === c && (c = 0);
            void 0 === b && (b = 1);
            void 0 === a && (a = !1);
        ...
        d.moveTo = function (d, c) {
            this._pushCommand(new f(function (b, a) {
                var c = this.renderContext;
                this.canvasContext.moveTo(c._transformTx + b, c._transformTy + a)
            }, this, [d, c]))
        };
        d.clear = function () {
    ...
    (function (d) {
        var f = function (e) {
            function c(a) {
                ...
                for (var b = 0, c = 0; b < a; b += 6, c += 4) this.indices[b + 0] = c + 0,
            ...
            b.initAll = function () {
                ...
                function () {
                    ...
                    l = a._anchorOffsetX;
                    n = a._anchorOffsetY;
                    if (0 != a._anchorX || 0 != a._anchorY) l = a._anchorX * h,
                    n = a._anchorY * e;
                    this._offsetX = f + l;
                    this._offsetY = k + n;
                    a._worldTransform.append(1, 0, 0, 1, -this._offsetX, -this._offsetY);
                    ...
                    d.MainContext.__use_new_draw = !1;
                    if (a instanceof d.DisplayObjectContainer) for (f = a._children, k = 0, l = f.length; k < l; k++) f[k]._updateTransform();
                    this.renderContext.setTransform(a._worldTransform);
                    f = d.RenderFilter.getInstance();
                    k = f._drawAreaList.concat();
                    f._drawAreaList.length = 0;
            ...
            b.drawRepeatImage = function (a, b, c, e, f, k, h, m, l, n) {
                ...
                e *= n;
                for (f *= n; k < m; k += e) for (var p = h; p < l; p += f) {
            ...
            b.drawImage = function (a, b, c, d, e, f, h, m, l, n) {
                void 0 === n && (n = void 0);
                if (!this.contextLost) if (void 0 !== n) this.drawRepeatImage(a, b, c, d, e, f, h, m, l, n);
                else {
        ...
        var f = function () {
            ...
            c.createGroup = function (b, a, c) {
                ...
                for (var d = [], e = a.length, f = 0; f < e; f++) {
                    var k = a[f],
                        h = c[k];
                    if (h) for (var k = h.length, m = 0; m < k; m++) {
                            var l = h[m]; - 1 == d.indexOf(l) && d.push(l)
            ...
            c.parseConfig = function (b, a) {
                if (b) {
                    ...
                    if (c = b.groups) for (d = c.length, e = 0; e < d; e++) {
                        for (var k = c[e], h = [], m = k.keys.split(","), l = m.length, n = 0; n < l; n++) f = m[n].trim(),
    ...
    (function (d) {
        ...
        var f = function (c) {
            ...
            a.removeLoadedGroupsByItemName = function (a) {
                for (var b = this.loadedGroups, c = b.length, d = 0; d < c; d++) for (var e = this.resConfig.getRawGroupByName(b[d]), f = e.length, m = 0; m < f; m++) if (e[m].name == a) {
                    b.splice(d, 1);
                    d--;
                    c = b.length;
                    break
